 ...
 **/
static si_t send_request_and_recv_respond(si_t request_type, si_t respond_type, addr_t body, ui_t body_size, addr_t result)
{
...
static si_t send_request_and_malloc_for_respond(si_t request_type, si_t respond_type, addr_t body, ui_t body_size, addr_t* result)
{
	if(0 != comm_send_request(lib_uds, request_type, body, body_size))
	{
		EGUI_PRINT_ERROR("failed to send request[%s]", request_type_to_str(request_type));
 ...
 **/
static si_t send_request_and_return_respond(si_t request_type, si_t respond_type, addr_t body, ui_t body_size)
{
 ...
 **/
static si_t send_body_with_extra_context_and_return_respond(si_t request_type, si_t respond_type, addr_t body, ui_t body_len, addr_t extra_context, ui_t extra_context_len)
{
	si_t result = 0;
...
extern si_t register_application(si_t video_access_mode, si_t application_type, char* name)
{
	...
	return send_body_with_extra_context_and_return_respond(REQUEST_TYPE_REGISTER_APPLICATION, RESPOND_TYPE_REGISTER_APPLICATION, (addr_t)&body, sizeof(body), (addr_t)name, strlen(name) + 1);
}
...
extern si_t graphics_device_init(si_t x_axis, si_t y_axis, si_t x_size, si_t y_size, si_t r, si_t g, si_t b, si_t a, si_t font)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_GRAPHICS_DEVICE_INIT, RESPOND_TYPE_GRAPHICS_DEVICE_INIT, (addr_t)&body, sizeof(body));
}
...
extern si_t graphics_device_exit(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_GRAPHICS_DEVICE_EXIT, RESPOND_TYPE_GRAPHICS_DEVICE_EXIT, (addr_t)&body, sizeof(body));
}

extern si_t window_manager_quit()
{
	return send_request_and_return_respond(REQUEST_TYPE_WINDOW_MANAGER_QUIT, RESPOND_TYPE_WINDOW_MANAGER_QUIT, NULL, 0);
}
...
extern si_t update(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_UPDATE, RESPOND_TYPE_UPDATE, (addr_t)&body, sizeof(body));
}

extern si_t desktop_dirty()
{
	return send_request_and_return_respond(REQUEST_TYPE_DESKTOP_DIRTY, RESPOND_TYPE_DESKTOP_DIRTY, (addr_t)NULL, 0);
}
...
extern si_t register_window(si_t parent_window_descriptor, char* title, si_t x, si_t y, si_t width, si_t height, si_t minimize_enable, si_t maximize_enable, si_t modal)
{
	 ...
	 **/
	return send_body_with_extra_context_and_return_respond(REQUEST_TYPE_REGISTER_WINDOW, RESPOND_TYPE_REGISTER_WINDOW, (addr_t)&body, sizeof(body), (addr_t)title, strlen(title) + 1);
}
...
extern si_t cancel_window(si_t window_descriptor)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_CANCEL_WINDOW, RESPOND_TYPE_CANCEL_WINDOW, (addr_t)&body, sizeof(body));
}
...
extern si_t move_window(si_t window_descriptor, si_t x_axis, si_t y_axis)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_MOVE_WINDOW, RESPOND_TYPE_MOVE_WINDOW, (addr_t)&body, sizeof(body));
}
...
extern si_t resize_window(si_t window_descriptor, si_t x_axis, si_t y_axis, si_t x_size, si_t y_size)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_RESIZE_WINDOW, RESPOND_TYPE_RESIZE_WINDOW, (addr_t)&body, sizeof(body));
}
...
extern si_t minimize_window(si_t window_descriptor)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_MINIMIZE_WINDOW, RESPOND_TYPE_MINIMIZE_WINDOW, (addr_t)&body, sizeof(body));
}
...
extern si_t maximize_window(si_t window_descriptor, struct rectangle* result)
{
	...
	return send_request_and_recv_respond(REQUEST_TYPE_MAXIMIZE_WINDOW, RESPOND_TYPE_MAXIMIZE_WINDOW, (addr_t)&body, sizeof(body), result);
}
...
extern si_t restore_window(si_t window_descriptor, struct rectangle* area)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_RESTORE_WINDOW, RESPOND_TYPE_RESTORE_WINDOW, (addr_t)&body, sizeof(body));
}
...
extern si_t activate_window(si_t window_descriptor)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_ACTIVATE_WINDOW, RESPOND_TYPE_ACTIVATE_WINDOW, (addr_t)&body, sizeof(body));
}
...
extern si_t clear(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_CLEAR, RESPOND_TYPE_CLEAR, (addr_t)&body, sizeof(body));
}
...
extern si_t clear_black(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_CLEAR_BLACK, RESPOND_TYPE_CLEAR_BLACK, (addr_t)&body, sizeof(body));
}
...
extern si_t clear_white(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_CLEAR_WHITE, RESPOND_TYPE_CLEAR_WHITE, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_point(si_t gd, si_t x, si_t y)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_POINT, RESPOND_TYPE_DRAW_POINT, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_line(si_t gd, si_t x1, si_t y1, si_t x2, si_t y2)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_LINE, RESPOND_TYPE_DRAW_LINE, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_rectangle(si_t gd, si_t x_axis, si_t y_axis, si_t x_size, si_t y_size)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_RECTANGLE, RESPOND_TYPE_DRAW_RECTANGLE, (addr_t)&body, sizeof(body));
}

extern si_t draw_polygon(si_t gd, struct point * p, si_t point_count)
{
	 ...
	 **/
	return send_body_with_extra_context_and_return_respond(REQUEST_TYPE_DRAW_POLYGON, RESPOND_TYPE_DRAW_POLYGON, (addr_t)&body, sizeof(body), (addr_t)p, point_count * sizeof(struct point));
}
...
extern si_t draw_circle(si_t gd, si_t x, si_t y, si_t radius)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_CIRCLE, RESPOND_TYPE_DRAW_CIRCLE, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_ellipse(si_t gd, si_t x, si_t y, si_t a, si_t b)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_ELLIPSE, RESPOND_TYPE_DRAW_ELLIPSE, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_x(si_t gd, si_t x, si_t y, si_t a, si_t b)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_X, RESPOND_TYPE_DRAW_X, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_arrow(si_t gd, si_t x, si_t y, si_t size, si_t direction)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_DRAW_ARROW, RESPOND_TYPE_DRAW_ARROW, (addr_t)&body, sizeof(body));
}
...
extern si_t draw_img(si_t gd, char* img_path, si_t align)
{
	 ...
	 **/
	return send_body_with_extra_context_and_return_respond(REQUEST_TYPE_DRAW_IMG, RESPOND_TYPE_DRAW_IMG, (addr_t)&body, sizeof(body), (addr_t)img_path, strlen(img_path) + 1);
}
...
extern si_t draw_bitmap(si_t gd, char* name, int align)
{
	 ...
	 * 画图需要较为复杂的请求包：标准请求包外加路径字符串内容
	 **/
	return send_body_with_extra_context_and_return_respond(REQUEST_TYPE_DRAW_BITMAP, RESPOND_TYPE_DRAW_BITMAP, (addr_t)&body, sizeof(body), (addr_t)name, strlen(name) + 1);
}
...
extern si_t fill_rectangle(si_t gd, si_t x_axis, si_t y_axis, si_t x_size, si_t y_size)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_FILL_RECTANGLE, RESPOND_TYPE_FILL_RECTANGLE, (addr_t)&body, sizeof(body));
}
...
extern si_t fill_circle(si_t gd, si_t x, si_t y, si_t radius)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_FILL_CIRCLE, RESPOND_TYPE_FILL_CIRCLE, (addr_t)&body, sizeof(body));
}
...
extern si_t fill_ellipse(si_t gd, si_t x, si_t y, si_t a, si_t b)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_FILL_ELLIPSE, RESPOND_TYPE_FILL_ELLIPSE, (addr_t)&body, sizeof(body));
}
...
extern si_t fill_x(si_t gd, si_t x, si_t y, si_t a, si_t b)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_FILL_X, RESPOND_TYPE_FILL_X, (addr_t)&body, sizeof(body));
}
...
extern si_t fill_arrow(si_t gd, si_t x, si_t y, si_t size, si_t direction)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_FILL_ARROW, RESPOND_TYPE_FILL_ARROW, (addr_t)&body, sizeof(body));
}
...
extern si_t cpy_area(si_t gd, si_t mode, si_t dst_x, si_t dst_y, si_t src_x, si_t src_y, si_t x_size, si_t y_size)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_CPY_AREA, RESPOND_TYPE_CPY_AREA, (addr_t)&body, sizeof(body));
}
...
extern si_t show_text(si_t gd, si_t x, si_t y, char * str, si_t size)
{
	 ...
	 **/
	return send_body_with_extra_context_and_return_respond(REQUEST_TYPE_SHOW_TEXT, RESPOND_TYPE_SHOW_TEXT, (addr_t)&body, sizeof(body), (addr_t)str, strlen(str) + 1);
}
...
extern si_t get_area(si_t gd, struct rectangle * result)
{
	...
	return send_request_and_recv_respond(REQUEST_TYPE_GET_AREA, RESPOND_TYPE_GET_AREA, (addr_t)&body, sizeof(body), (addr_t)result);
}
...
extern si_t get_color(si_t gd, struct color * result)
{
	...
	return send_request_and_recv_respond(REQUEST_TYPE_GET_COLOR, RESPOND_TYPE_GET_COLOR, (addr_t)&body, sizeof(body), (addr_t)result);
}

extern si_t get_color_limit(struct color_limit * result)
{
	return send_request_and_recv_respond(REQUEST_TYPE_GET_COLOR_LIMIT, RESPOND_TYPE_GET_COLOR_LIMIT, NULL, 0, (addr_t)result);
}
...
extern si_t get_font_width(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_GET_FONT_WIDTH, RESPOND_TYPE_GET_FONT_WIDTH, (addr_t)&body, sizeof(body));
}
...
extern si_t get_font_height(si_t gd)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_GET_FONT_HEIGHT, RESPOND_TYPE_GET_FONT_HEIGHT, (addr_t)&body, sizeof(body));
}

extern si_t get_screen_width()
{
	return send_request_and_return_respond(REQUEST_TYPE_GET_SCREEN_WIDTH, RESPOND_TYPE_GET_SCREEN_WIDTH, NULL, 0);
}

extern si_t get_screen_height()
{
	return send_request_and_return_respond(REQUEST_TYPE_GET_SCREEN_HEIGHT, RESPOND_TYPE_GET_SCREEN_HEIGHT, NULL, 0);
}
...
extern si_t set_area(si_t gd, si_t x_axis, si_t y_axis, si_t x_size, si_t y_size)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_SET_AREA, RESPOND_TYPE_SET_AREA, (addr_t)&body, sizeof(body));
}
...
extern si_t set_color(si_t gd, ui_t r, ui_t g, ui_t b, ui_t a)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_SET_COLOR, RESPOND_TYPE_SET_COLOR, (addr_t)&body, sizeof(body));
}
...
extern si_t set_font(si_t gd, si_t font)
{
	...
	return send_request_and_return_respond(REQUEST_TYPE_SET_FONT, RESPOND_TYPE_SET_FONT, (addr_t)&body, sizeof(body));
}
...
extern char* get_window_title(si_t window_descriptor)
{
	...
	send_request_and_malloc_for_respond(REQUEST_TYPE_SET_FONT, RESPOND_TYPE_SET_FONT, (addr_t)&body, sizeof(body), (addr_t)&title);
	return title;
}
